...
export const workGroups: WorkGroup[] = [
  {
    ...
    fieldDispatcher: ['陈某', '李某'],
    fieldDispatcherPhone: ['13900139001', '13900139002'],
    pendingTaskCount: 2,
  ...
  },
  {
    ...
    location: '东方酒店',
    fieldDispatcher: ['王某'],
    fieldDispatcherPhone: ['13900139003'],
    pendingTaskCount: 1,
  ...
  },
  {
    ...
    fieldDispatcher: ['陈某', '张某'],
    fieldDispatcherPhone: ['13900139001', '13900139004'],
    pendingTaskCount: 0,
...
export const tasks: Task[] = [
  ...
  },
  {
    ...
    to: '琶洲展馆',
    toTime: '17:30',
    waypoints: [{ name: '珠江新城', order: 1, time: '15:30' }],
    reachedLocations: [],
    passenger: '上海企业代表3人',
  ...
  },
  {
    ...
    to: '白天鹅宾馆',
    toTime: '19:00',
    waypoints: [{ name: '海心沙', order: 1, time: '17:30' }],
    reachedLocations: [],
    passenger: 'VIP客户2人',
    passengerPhone: '13888889999',
    passengerCount: 2,
    description: '接送VIP客户入住宾馆',
    vehicleId: 'v-3',
    driverId: 'd-1',
    fieldDispatcher: '陈某',
    fieldDispatcherPhone: '13900139001',
    status: '已接收',
    history: [
      { status: '待派发', time: new Date(Date.now() - 36000000).toISOString(), operator: '调度员', remark: '创建任务' },
      { status: '待接收', time: new Date(Date.now() - 18000000).toISOString(), operator: '调度员', remark: '任务下发' },
      { status: '已接收', time: new Date(Date.now() - 18000000).toISOString(), operator: '李师傅', remark: '接收任务' }
    ]
  },
  {
    id: 't-2',
